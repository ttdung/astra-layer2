	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				...
				_, found := suite.app.ParamsKeeper.GetSubspace(types.ModuleName)
				...
				//suite.app.Erc20Keeper = keeper.NewKeeper(suite.app.GetKey("erc20"), suite.app.AppCodec(),
				//sp, suite.app.AccountKeeper,
